...
date: 2024-04-22
description: "Getting started in Mekanism V10, a Minecraft tech mod."
...
> [!TIP]
> You should use the enriched version of materials in the metallurgic infuser whenever possible. This is especially important in later progression, where elite alloys and circuits will be infused with diamonds and obsidian.
...
> [!TIP]
> Configure your energy cube to input and output energy on all sides.
...
> [!TIP]
> Most of Mekanism's blocks will store their contents, upgrades, and energy when broken.
...
> [!TIP]
> If you don't want to break your machines every time you upgrade them, use tier installers.
