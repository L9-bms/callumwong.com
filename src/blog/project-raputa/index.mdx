...
> [!TIP]
> In the options before starting the track, change the DISPLAY AT CENTER setting to COMBO.
...
> [!INFO] 
> It is optional to complete the 月面ちほー (Lunar Surface Area) (240km). But why wouldn't you?
...
> [!TIP]
> To perform this alone, insert 2 credits as if you were playing with another person. This allows you to play all 4 difficulties in a single play.
>
...
> [!WARNING]
> If the area does not unlock on your next play, make sure you equip BOTH the icon and the nameplate. Don't do this:
>
